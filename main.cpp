...
void display2() {
    ...
    drawAmongUs(-5000, 650, walkX_late_2, walkY_late_2, 190, 76, 20, 136, 57, 16, .5, .5);
    drawAmongUsBig_2(-100, -2200, walkX_big_2, walkY_big_2, 1.5, 1.5);
...
void display4() {
    ...
    drawAmongUs(0 - 200, 1000 - 150, walkXs4b, walkYs4b, 112, 155, 107, 84, 113, 59, 0.6, 0.6);           //green
    drawAmongUs(170 - 200 , 1050 - 150, walkXs4b, walkYs4b, 230, 180, 193, 226, 143, 173, 0.6, 0.6);     //pink
    drawAmongUs(50 - 200, 1225 - 150, walkXs4c, walkYs4c, 190, 76, 20, 136, 57, 16, 0.6, 0.6);        //orange
    drawAmongUs(-150 - 200, 1150 - 150, walkXs4a, walkYs4a, 242, 219, 39, 242, 188, 34, 0.6, 0.6);      //yellow
    drawAmongUs(-100 - 200, 1380 - 150, walkXs4a, walkYs4a, 167, 27, 20, 91, 15, 8, 0.6, 0.6);          //red
    drawAmongUs(200 - 200, 1380 - 150, walkXs4a, walkYs4a, 61, 98, 219, 34, 61, 148, 0.6, 0.6);         //blue=
    //glutIdleFunc(idle4);
...
void switchDisplay(int value) {
    ...
    else if (value == 2) //Display Scene 1.1
    {
        ...
        glutTimerFunc(5000, switchDisplay, 3);       //6second
    }
    else if (value == 3)   //Display Scene 2
    {
        glutDisplayFunc(display2);
        glutTimerFunc(1, timer, 5);
        glutTimerFunc(7800, switchDisplay, 4);       //11second
    }
    else if (value == 4)   //Display Scene 2.1
    {
        ...
        glutTimerFunc(11000, switchDisplay, 5);
    }
    else if (value == 5) {
        glutDisplayFunc(display3);
        glutTimerFunc(1, timer, 0);
        glutTimerFunc(6000, switchDisplay, 6); //9second
    }
    else if (value == 6) {
        glutDisplayFunc(display4);
        glutTimerFunc(1, timer, 1);
        glutTimerFunc(8500, switchDisplay, 7);
    }
    else if (value == 7) {
        ...
        glutDisplayFunc(display5);
        glutTimerFunc(1200, timer, 14);
        glutTimerFunc(11000, switchDisplay, 9);
    }
    else if (value == 9) {
        glutDisplayFunc(displays6);
        glutTimerFunc(1, timer, 3);
        glutTimerFunc(8500, switchDisplay, 10);
    }
    else if (value == 10) {
        ...
        glutTimerFunc(7300, switchDisplay, 12);
    }
    else if (value == 12) {
        glutDisplayFunc(displayBubble3s6);
        glutTimerFunc(2000, switchDisplay, 13);
    }
    else if (value == 13) {
